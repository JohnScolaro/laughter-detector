...
for number = 1:files
    ...
    % Load song
    [y, Fs] = audioread(strcat('C:\Users\John\Desktop\Thesis Project\laughter-detector\demo\audio_file\', num, '.wav'));
    if (size(y, 2) == 2)
       y = y(1:end, 1);
    end
    ...
    csvwrite(strcat('C:\Users\John\Desktop\Thesis Project\laughter-detector\demo\audio_file\', num, '_dataset.csv'), [transpose(cept_d_dd), transpose(recording_labels), transpose(count), transpose(nn_labels)]);
